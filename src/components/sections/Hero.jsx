...
export default function Hero() {
  ...
  return (
    <section className='relative min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col justify-center items-center text-center overflow-hidden'>
      {/* ambient drifting color blob — one deliberate motion moment, not per-section decoration */}
      <motion.div
        aria-hidden='true'
      ...
      {/* stack row — quick credibility signal, edit labels to taste */}
      <motion.div
        initial={{ opacity: 0 }}
